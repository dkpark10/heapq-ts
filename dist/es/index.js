const e = (h) => typeof h == "object" && h !== null || Array.isArray(h);
class o {
  constructor(i) {
  ...
  compare(i, t) {
    if (typeof this.comparator == "function")
      return this.comparator(i, t) < 1;
    if (this.comparator.min === !0 && this.comparator.max === !0)
      throw new Error("");
  ...
  push(i) {
    ...
    this.list.push(i);
    let t = this.list.length - 1, s = Math.ceil(t / 2) - 1;
  ...
  pop() {
    ...
    for (; t * 2 < this.list.length - 1; ) {
      const s = t * 2 + 1, r = t * 2 + 2;
      if (this.list[s] === void 0)
        break;
      if (this.list[r] === void 0) {
        this.compare(this.list[t], this.list[s]) || this.swap(t, s);
        break;
      }
      if (this.compare(this.list[t], this.list[s]) && this.compare(this.list[t], this.list[r]))
        break;
